...
//                         <div className="text-xs bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 group-hover:bg-blue-200 dark:group-hover:bg-blue-800 px-2 py-1 rounded-full mt-2 inline-block transition-colors duration-200">
//                           {dropdownItem.recommended}
//                         </div>
//                       )}
//                     </div>
...
//                             )}
//                             {dropdownItem.recommended && (
//                               <div className="text-xs bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 px-2 py-1 rounded-full mt-2 inline-block">
//                                 {dropdownItem.recommended}
//                               </div>
//                             )}
//                           </div>
...
//   const isTransparent = !scrolled && !activeDropdown
