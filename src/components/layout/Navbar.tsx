...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setScrolled(window.scrollY > 100); // Changed to 100px for better trigger point
    };
  ...
  return (
    <>
      ...
      <div className={`fixed ${scrolled ? 'top-0' : 'top-4'} left-0 right-0 z-50 transition-all duration-300`}>
        {scrolled ? (
          /* Scrolled - Full Width White Header */
          ...
          <div className="flex items-center justify-center px-4">
            <div className="flex items-center gap-x-4 w-full max-w-7xl">
              ...
              <nav className="flex-1">
                <div className="bg-black/20 backdrop-blur-lg border border-white/10 rounded-full px-6 py-3 shadow-xl">
                  {/* Desktop Navigation */}
