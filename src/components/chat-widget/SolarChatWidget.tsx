...
// import { Sun, Send, Shield, Phone, Building, Home, MapPin, Ruler, Lightbulb, Users, CheckCircle, Calendar, Mail, User, UserCheck } from "lucide-react";
...
//       const response = await apiRequest('POST', '/api/solar-leads', leadData);
...
//       toast({
//         title: "Error",
//         description: "Failed to calculate solar savings. Please try again.",
//         variant: "destructive"
//       });
//     }
//   });
...
//       entityType: userData.entityType || 'home',
//       location: userData.location || '',
//       roofArea: userData.roofArea || 'medium',
//       monthlyBill: userData.monthlyBill || 'mid',
//       referralSource: userData.referralSource || 'online',
//       referralName: userData.referralName || null,
//       referralPhone: userData.referralPhone || null
//     };
...
//   return (
//     <div className="max-w-md mx-auto bg-white shadow-2xl rounded-lg overflow-hidden min-h-screen md:min-h-[600px] md:max-h-[800px] md:my-8 flex flex-col">
//       {/* Chat Header */}
//       <div className="solar-gradient p-4 flex items-center space-x-3 shadow-lg">
//         <div className="relative">
//           <div className="w-12 h-12 orange-gradient rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
//             <Sun className="w-6 h-6 animate-bounce-light" />
//           </div>
...
//       {/* Chat Messages */}
//       <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gradient-to-b from-gray-50 to-white" style={{ maxHeight: '500px' }}>
//         <AnimatePresence>
...
//             >
//               {!message.isUser && (
//                 <div className="w-8 h-8 orange-gradient rounded-full flex items-center justify-center text-white text-sm">
...
//               <div className={`${
//                 message.isUser 
//                   ? 'chat-bubble-user rounded-lg rounded-tr-none' 
//                   : 'chat-bubble-ai rounded-lg rounded-tl-none'
...
//                 className="solar-gradient text-white p-3 rounded-full hover:opacity-90"
//               >
...
//                 className="w-full solar-gradient text-white hover:opacity-90"
//               >
//                 Continue
//               </Button>
//             </div>
...
//                   className="flex-1 solar-gradient text-white hover:opacity-90"
//                 >
//                   Complete Assessment
//                 </Button>
//                 <Button 
...
//               </Button>
//               <Button className="w-full solar-gradient text-white hover:opacity-90">
