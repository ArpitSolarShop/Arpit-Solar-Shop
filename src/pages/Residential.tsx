...
// // START: UPDATED PRICE COMPARISON TOOL
...
//   // --- New analysis logic for three systems ---
...
//   ].filter(s => s.data); // Filter out any brands that don't have a matching system
...
//             {/* Map through the systems to display them dynamically */}
...
//                     <div className="flex justify-between"><span>Price/Watt:</span><span className="font-medium">₹{data.pricePerWatt.toFixed(2)}</span></div>
//                     <div className="flex justify-between"><span>Total Price:</span><span className="font-bold text-green-600">₹{data.totalPrice.toLocaleString("en-IN")}</span></div>
//                     <div className="flex justify-between"><span>Monthly Savings:</span><span className="font-medium text-green-600">₹{data.monthlySavings.toLocaleString("en-IN")}</span></div>
...
//                      ₹{bestValue.data!.totalPrice.toLocaleString("en-IN")}
//                   </span>
//                 </div>
//               </div>
//             </div>
...
//   );
// }
// // END: UPDATED PRICE COMPARISON TOOL
...
//       <section className="py-20 px-4 md:px-8 bg-gray-100">
//         <div className="max-w-7xl mx-auto">
//            {/* Pass all three data sets to the updated component */}
...
//                   </Button>
//                   <Button variant="outline" className="border-gray-400 text-gray-700 hover:bg-gray-200 bg-transparent" onClick={() => {
//                     setSelectedTataProduct({ ...customQuoteTemplate, slNo: 0, systemSize: 10 });
//                     setIsTataFormOpen(true);
//                   }}>
