            ...
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div><Label className="text-sm font-medium text-gray-600">Monthly Bill</Label><p>{quote.monthly_bill ? `₹${quote.monthly_bill}` : quote.monthly_bill_range || 'Not provided'}</p></div>
