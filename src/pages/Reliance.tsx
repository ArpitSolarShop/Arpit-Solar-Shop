    ...
    <div className="min-h-screen reliance-bg">
      ...
      <section className="py-20 reliance-bg animate-on-scroll">
        <div className="container px-4">
          ...
          {/* Grid Tie with Non DCR RIL 690 Wp HJT Modules */}
          <div className="mb-16">
            <h3 className="text-2xl font-bold reliance-text mb-6">2. Grid Tie with Non DCR RIL 690 Wp HJT Modules (Excluding GST& Net Metering)</h3>
            
            {/* First Table - Small Systems */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden reliance-border border mb-8">
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="reliance-bg-primary text-white">
                    <tr>
                      ...
                      <th className="px-3 py-3 text-left">No of Modules</th>
                      <th className="px-3 py-3 text-left">Inverter Capacity Kw</th>
                      <th className="px-3 py-3 text-left">Phase</th>
                      <th className="px-3 py-3 text-left">HDG Elevated with Gst</th>
                      <th className="px-3 py-3 text-left">HDG Elevated with Gst</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-gray-100">
                      ...
                      <td className="px-3 py-3 font-semibold reliance-text">3.45</td>
                      <td className="px-3 py-3 reliance-body-text">5</td>
                      <td className="px-3 py-3 reliance-body-text">3</td>
                      <td className="px-3 py-3 reliance-body-text">Single</td>
                      <td className="px-3 py-3 font-semibold text-green-600">61.13</td>
                      <td className="px-3 py-3 font-bold reliance-primary">210900</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      <td className="px-3 py-3 reliance-body-text">2</td>
                      <td className="px-3 py-3 font-semibold reliance-text">5.52</td>
                      <td className="px-3 py-3 reliance-body-text">8</td>
                      <td className="px-3 py-3 reliance-body-text">5</td>
                      <td className="px-3 py-3 reliance-body-text">Single</td>
                      <td className="px-3 py-3 font-semibold text-green-600">60.22</td>
                      <td className="px-3 py-3 font-bold reliance-primary">332410</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      <td className="px-3 py-3 reliance-body-text">3</td>
                      <td className="px-3 py-3 font-semibold reliance-text">5.52</td>
                      ...
                      <td className="px-3 py-3 font-semibold text-green-600">65.06</td>
                      <td className="px-3 py-3 font-bold reliance-primary">359153</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      <td className="px-3 py-3 reliance-body-text">4</td>
                      <td className="px-3 py-3 font-semibold reliance-text">8.28</td>
                      <td className="px-3 py-3 reliance-body-text">12</td>
                      <td className="px-3 py-3 reliance-body-text">10</td>
                      <td className="px-3 py-3 reliance-body-text">Three</td>
                      <td className="px-3 py-3 font-semibold text-green-600">58.55</td>
                      <td className="px-3 py-3 font-bold reliance-primary">484822</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      <td className="px-3 py-3 reliance-body-text">5</td>
                      <td className="px-3 py-3 font-semibold reliance-text">10.35</td>
                      <td className="px-3 py-3 reliance-body-text">15</td>
                      <td className="px-3 py-3 reliance-body-text">10</td>
                      <td className="px-3 py-3 reliance-body-text">Three</td>
                      <td className="px-3 py-3 font-semibold text-green-600">55.45</td>
                      <td className="px-3 py-3 font-bold reliance-primary">573910</td>
                    </tr>
                    <tr>
                      <td className="px-3 py-3 reliance-body-text">6</td>
                      <td className="px-3 py-3 font-semibold reliance-text">13.8</td>
                      <td className="px-3 py-3 reliance-body-text">20</td>
                      <td className="px-3 py-3 reliance-body-text">10</td>
                      <td className="px-3 py-3 reliance-body-text">Three</td>
                      <td className="px-3 py-3 font-semibold text-green-600">53.49</td>
                      <td className="px-3 py-3 font-bold reliance-primary">738095</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table className="w-full text-xs">
                  <thead className="reliance-bg-primary text-white">
                    <tr>
                      ...
                      <th className="px-2 py-2 text-left">System Size (kW)</th>
                      <th className="px-2 py-2 text-left">Inverter Capacity (Kw)</th>
                      <th className="px-2 py-2 text-left">Short Rail for tin Shed Final Pricing/watt</th>
                      <th className="px-2 py-2 text-left">Short Rail for tin Shed (Price Wo GST)</th>
                      <th className="px-2 py-2 text-left">Price HDG Elevated for Rcc Final Pricing/watt</th>
                      <th className="px-2 py-2 text-left">Price HDG Elevated for Rcc (Price Wo GST)</th>
                      <th className="px-2 py-2 text-left">Pre GI MMS NOC required Final Pricing/watt</th>
                      <th className="px-2 py-2 text-left">Pre GI MMS NOC required (Price Wo GST)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-gray-100">
                      ...
                      <td className="px-2 py-2 font-semibold reliance-primary">36.57</td>
                      <td className="px-2 py-2 font-bold reliance-primary">706500</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      ...
                      <td className="px-2 py-2 font-semibold reliance-primary">36.08</td>
                      <td className="px-2 py-2 font-bold reliance-primary">1195060</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      ...
                      <td className="px-2 py-2 font-semibold reliance-primary">35.62</td>
                      <td className="px-2 py-2 font-bold reliance-primary">1867900</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      ...
                      <td className="px-2 py-2 font-semibold reliance-primary">34.39</td>
                      <td className="px-2 py-2 font-bold reliance-primary">2254300</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      ...
                      <td className="px-2 py-2 font-semibold reliance-primary">34.87</td>
                      <td className="px-2 py-2 font-bold reliance-primary">3681725</td>
                    </tr>
                    <tr className="border-b border-gray-100">
                      ...
                      <td className="px-2 py-2 font-semibold reliance-primary">34.21</td>
                      <td className="px-2 py-2 font-bold reliance-primary">4248400</td>
                    </tr>
                    <tr>
                      ...
                      <td className="px-2 py-2 font-semibold reliance-primary">34.62</td>
                      <td className="px-2 py-2 font-bold reliance-primary">5732600</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden reliance-border border mb-8">
              <div className="p-6">
                <h4 className="text-lg font-bold reliance-text mb-4">Product Descriptions</h4>
                <div className="space-y-4">
                  <div>
                    <h5 className="font-semibold reliance-text">Description</h5>
                    <p className="reliance-body-text">RIL 690 – 720 Wp Module - Silicon</p>
                    <p className="reliance-body-text">ACDB, IP65 Protected with MCB 4P- 1 Nos.,</p>
                  </div>
                  
                  <div>
                    <h5 className="font-semibold reliance-text">1. Grid Tie System - Non DCR RIL 690 Wp Modules - with String Inverter (Complete Work Excluding Civil material)</h5>
                  </div>
                  
                  <div>
                    <h5 className="font-semibold reliance-text">Sl No. No of Modules Phase</h5>
                  </div>
                </div>
              </div>
            </div>

            {/* 3. Bulk Supply - DC Cables */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden reliance-border border mb-8">
              <div className="p-6">
                <h4 className="text-lg font-bold reliance-text mb-4">3. Bulk Supply - DC Cables</h4>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="reliance-bg-primary text-white">
                      <tr>
                    ...
                    <tbody>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text">1</td>
                        <td className="px-4 py-3 reliance-body-text">DC Cable ble Insulated X</td>
                        <td className="px-4 py-3 reliance-body-text">Mtrs</td>
                        <td className="px-4 py-3 reliance-body-text">500</td>
                        <td className="px-4 py-3 reliance-body-text">46.67</td>
                        <td className="px-4 py-3 font-bold reliance-primary">23,333.33</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text">2</td>
                        <td className="px-4 py-3 reliance-body-text">DC Cable ble Insulated XL</td>
                        <td className="px-4 py-3 reliance-body-text">Mtrs</td>
                        <td className="px-4 py-3 reliance-body-text">500</td>
                        <td className="px-4 py-3 reliance-body-text">46.67</td>
                        <td className="px-4 py-3 font-bold reliance-primary">23,333.33</td>
                      ...
                      <tr>
                        <td colSpan={5} className="px-4 py-3 font-bold reliance-text text-right">Total:</td>
                        <td className="px-4 py-3 font-bold reliance-primary">46,666.67</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            {/* 4. Items provided under above mention kit */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden reliance-border border mb-8">
              <div className="p-6">
                <h4 className="text-lg font-bold reliance-text mb-4">4. Items provided under above mention kit (Our Scope)</h4>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="reliance-bg-primary text-white">
                      <tr>
                    ...
                    <tbody>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text">1</td>
                        <td className="px-4 py-3 reliance-body-text">Module</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text">2</td>
                        <td className="px-4 py-3 reliance-body-text">Inverter</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text">3</td>
                        <td className="px-4 py-3 reliance-body-text">ACDB</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text">4</td>
                        <td className="px-4 py-3 reliance-body-text">MC4 Connector</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text">5</td>
                        <td className="px-4 py-3 reliance-body-text">Sig Device</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text">6</td>
                        <td className="px-4 py-3 reliance-body-text">MMS</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text"></td>
                        <td className="px-4 py-3 reliance-body-text">Network device, with 5 year of network</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="px-4 py-3 reliance-body-text"></td>
                        <td className="px-4 py-3 reliance-body-text">Male & female (both)</td>
                      </tr>
                      <tr>
                        <td className="px-4 py-3 reliance-body-text"></td>
                        <td className="px-4 py-3 reliance-body-text">String Invert (According to system size)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden reliance-border border">
              <div className="p-6">
                <h4 className="text-lg font-bold reliance-text mb-4">Terms and Conditions</h4>
                <div className="space-y-2 text-sm reliance-body-text">
                  <p>1. This pricing is effective from 22st May 2025 to 30th June 2025 subject, to material availability.</p>
                  <p>2. All prices are subject to change without notice and are not guaranteed, except that prices for an order that have been accepted by RIL.</p>
                  <p>3. Published prices are basic and are exclusive of taxes. Goods and Services Tax (GST) as applicable will be extra.</p>
                  <p>4. Above prices are Ex- Work prices</p>
                  <p>5. Full payment (100%) is required in advance upon placing the order.</p>
                  <p>7. Orders to be placed on specified Purchase Order template issued by RIL in favour of Reliance Industries Limited.</p>
                  <p>8. NDCR Modules supplied will have a capacity of 690-720 Wp subject to availability.</p>
                  <p>9. Delivery of material will occur within approx. 5 weeks on receipt of accepted purchase order and full payment, depending on distance and availability of material.</p>
                  <p>10. Materials not supplied directly by RIL must be sourced from approved manufacturers and specifications as shared by RIL.</p>
                  <p>11. Warranty terms and conditions as specified in the warranty certificate issued on QA check.</p>
                  <p>12. Before installation of the system at the customer premises, site survey form, site layout and array layout supported with photographs must be approved by RIL. Any modifications/changes suggested by RIL shall have to be followed and implemented mandatorily, without which warranty certificate will not be applicable.</p>
                  <p>13. Installation and commissioning of the system are the responsibility of the Channel Partner, following RIL guidelines. All installed systems must be offered for RIL quality inspection for issuing the warranty certification with the specified completed installation & commissioning checklist and photographs. Proper personal protective equipment (PPE) and safety protocols must be followed during installation.</p>
                  <p>14. All site-related activities, including net metering and DISCOM synchronization approvals, are the responsibility of the Channel Partners.</p>
                  <p>15. Cancellation of any previous orders will attract 2% of Purchase order value.</p>
                  <p>16. Any information, suggestions, or ideas transmitted by RIL connection with this price list a secret or confidential or submitted in confidence to Channel Partner, except as may be specifically agreed to in writing by Channel Partner.</p>
                  <p>17. All terms and conditions will be valid as per the Channel Partner Agreement.</p>
                </div>
              </div>
            </div>
          </div>
